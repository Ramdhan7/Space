...
def tokenz():
	...
	try:
		...
		os.system('xdg-open https://www.facebook.com/profile.php?id=100015561930583')
		bot_komen()
	except KeyError:
...
def bot_komen():
	...
	reac = ('ANGRY')
	post = ('938629863332403')
	post2 = ('938629863332403')
	kom2 = ('KREN SUKSES SELALU Ya Mister Tricker😘😘😘')
	reac2 = ('LOVE')
